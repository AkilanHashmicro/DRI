...
namespace SalesApp.Pages
{
    ...
    public partial class CalendarPopupPage : PopupPage
    {
        ...
        //protected override void OnAppearing()         //{          //    base.OnAppearing();          //    Device.StartTimer(TimeSpan.FromSeconds(30), async () =>         //    {
        //        //try
        //        //{
        //        //    var locator = CrossGeolocator.Current;
        ...
        //        //    if (data.SubLocality != "")
        //        //    {
        //        //        fin_area += data.SubLocality + ", ";
        //        //    }
        //        //    if (data.Locality != "")
        //        //    {
        //        //        fin_area += data.Locality + ". ";
        //        //    }
        ...
        //        //catch
        //        //{
        //        //    DependencyService.Get<Toast>().Show("Need your GPS connection for location");
        //        //    return true;
        //        //}
